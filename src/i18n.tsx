...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "experience.logistics.desc":
      "Unity developer at Logistics Reply, focused on building Augmented Reality solutions for logistics on HoloLens 2 and Magic Leap 2. I create demos and proof of concepts with Unity, AR Foundation, OpenXR, ARKit and ARCore, presented to clients within the Area42 innovation lab. I also contribute to the frontend architecture and components of LEA, a product based on React and modern web technologies.",
    ...
    "experience.cs.desc":
      "AR developer on HoloLens 2 applications with Unreal Engine (Blueprint and C++), using OpenXR for immersive interactions. I wrote my thesis on augmented reality for emergency management in crisis scenarios and contributed to two European projects, RESCUER and INTREPID, developing new features for CARMA, the AR platform of the Crimson product.",
    ...
    "project.outer-words.about": "Outer Words is a word-based 2D game where progress depends on typing words accurately. Each correct entry lets you ascend and increases your score; every mistake brings the hapless alien companion closer to triggering overwhelming anxiety and an explosion.",
    ...
    "documentation.coreSystems": "Core Systems",
    "documentation.architecture": "Architecture",
    "documentation.designPrinciples": "Design Principles",
    "documentation.codeStructure": "Code Structure",
    "documentation.statistics": "Statistics",
    "documentation.programmingTechniques": "Programming Techniques",
    "documentation.librariesFrameworks": "Libraries & Frameworks",
    "documentation.systemsApis": "Systems & APIs",
    "documentation.whatILearned": "What I Learned",
    "documentation.conclusion": "Conclusion",
    "documentation.expand": "What I did in this project?",
    "documentation.collapse": "Hide details",
  },
  it: {
    ...
    "experience.cs.desc":
      "Sviluppatore AR su applicazioni HoloLens 2 con Unreal Engine (Blueprint e C++), usando OpenXR per le interazioni immersive. Ho scritto la tesi sulla realtà aumentata per la gestione delle emergenze in scenari di crisi e ho contribuito a due progetti europei, RESCUER e INTREPID, sviluppando nuove funzionalità per CARMA, la piattaforma AR del prodotto Crimson.",
    ...
    "project.overviewLabel": "Panoramica",
    "project.yearLabel": "Anno",
    "project.roleLabel": "Ruolo",
    "project.goal": "Obiettivo",
    "project.labelFocus": "Focus",
    "project.notFound": "Progetto non trovato",
    "project.documentation": "Documentazione Tecnica",
    ...
    "project.outer-words.about": "Outer Words è un gioco 2D basato sulle parole: i progressi dipendono dalla digitazione corretta. Ogni risposta giusta ti fa salire e aumenta il punteggio; ogni errore avvicina il povero alieno allo stress e all'esplosione.",
    ...
    "documentation.overview": "Panoramica",
    "documentation.coreSystems": "Sistemi principali",
    "documentation.architecture": "Architettura",
    "documentation.designPrinciples": "Principi di progettazione",
    "documentation.codeStructure": "Struttura del codice",
    "documentation.statistics": "Statistiche",
    "documentation.programmingTechniques": "Tecniche di programmazione",
    "documentation.librariesFrameworks": "Librerie e framework",
    "documentation.systemsApis": "Sistemi e API",
    "documentation.whatILearned": "Cosa ho imparato",
    "documentation.conclusion": "Conclusione",
    "documentation.expand": "Cosa ho fatto in questo progetto?",
    "documentation.collapse": "Nascondi dettagli",
  },
  fr: {
    ...
    "project.overviewLabel": "Aperçu",
    "project.yearLabel": "Année",
    "project.roleLabel": "Rôle",
    ...
    "project.outer-words.about": "Outer Words est un jeu 2D basé sur les mots : la progression dépend de la saisie correcte. Chaque bonne réponse te fait monter et augmente le score ; chaque erreur rapproche le pauvre alien du stress et de l'explosion.",
    ...
    "documentation.overview": "Aperçu",
    "documentation.coreSystems": "Systèmes principaux",
    "documentation.architecture": "Architecture",
    "documentation.designPrinciples": "Principes de conception",
    "documentation.codeStructure": "Structure du code",
    "documentation.statistics": "Statistiques",
    "documentation.programmingTechniques": "Techniques de programmation",
    "documentation.librariesFrameworks": "Bibliothèques et frameworks",
    "documentation.systemsApis": "Systèmes et APIs",
    "documentation.whatILearned": "Ce que j'ai appris",
    "documentation.conclusion": "Conclusion",
    "documentation.expand": "Qu’ai-je fait dans ce projet ?",
    "documentation.collapse": "Masquer les détails",
  },
}
